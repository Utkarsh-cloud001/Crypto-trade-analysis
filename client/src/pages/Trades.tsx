...
const Trades = () => {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            // Check file size (max 5MB just to be safe before base64 expansion)
                                        ...
                                        <div className="flex gap-2">
                                            {trade.screenshot && (
                                                <div className="relative group">
                                                    <button
                                                        onClick={() => {
                                                            setPreviewImage(trade.screenshot || null);
                                                            setIsPreviewOpen(true);
                                                        }}
                                                        className="group relative"
                                                    >
                                                        <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity z-50 pointer-events-none shadow-xl">
                                                            <img
                                                        ...
                                                        <div className="w-8 h-8 rounded bg-slate-700/50 flex items-center justify-center hover:bg-slate-600/50 transition-colors">
                                                            <img
                                                                src={trade.screenshot}
                                                                alt="Trade"
